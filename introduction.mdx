...
<img
  src="https://libredesk.io/hero-light.png"
  alt="Libredesk"
  className="rounded-lg border block dark:hidden"
/>
<img
  src="https://libredesk.io/hero-dark.png"
  alt="Libredesk"
  className="rounded-lg border hidden dark:block"
/>
