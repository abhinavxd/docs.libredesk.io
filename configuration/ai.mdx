...
Tools let an assistant call your own APIs while replying - look up an order, check a subscription, cancel something. Create them under **Admin → AI → Tools**, then grant them per assistant.
