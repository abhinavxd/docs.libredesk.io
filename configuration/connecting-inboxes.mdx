...
Connect your Gmail or Google Workspace inbox using OAuth 2.0 or an app password.
...
If you'd rather skip the Google Cloud Console, you can connect Gmail using a 16-character app password instead. Your Google account must have [2-Step Verification](https://myaccount.google.com/signinoptions/twosv) enabled for this option to be available.
