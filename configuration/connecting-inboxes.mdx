...
<Steps>
  ...
  <Step title="Create OAuth credentials">
    ...
    - Add your Libredesk callback URL to Authorized redirect URIs
  ...
  <Step title="Add inbox in Libredesk">
    In Libredesk, navigate to Admin → Inboxes → Add Inbox → Google:
    - Enter the Client ID
  ...
  <Step title="Complete authorization">
    You'll be redirected to Google's consent screen. Sign in with the Google account you want to connect and grant the requested permissions.
  </Step>
</Steps>
...
<Steps>
  <Step title="Register an app in Azure Portal">
    ...
    - Add your Libredesk callback URL as the Redirect URI
  </Step>
  ...
  <Step title="Add inbox in Libredesk">
    In Libredesk, navigate to Admin → Inboxes → Add Inbox → Microsoft:
    - Enter the Client ID
    - Enter the Client Secret
    - Enter the Tenant ID (optional, for single-tenant apps)
    - Click Authorize
  </Step>

  <Step title="Complete authorization">
    You'll be redirected to Microsoft's consent screen. Sign in with the Microsoft account you want to connect and grant the requested permissions.
  </Step>
</Steps>
