...
Libredesk is a single binary application that can be deployed using Docker (which includes all dependencies) or installed directly (which requires PostgreSQL and Redis). Choose your preferred installation method below.
