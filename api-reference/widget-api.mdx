---
title: Widget API
description: Build custom live chat widget frontends with Libredesk's public widget endpoints and WebSocket protocol
---
...
include `last_name`, `phone_number`, `phone_number_country_code` (ISO 3166-1
alpha-2, e.g. `IN`), and `contact_custom_attributes`.
